 ...
 * @generated
 */
public class KeyNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public KeyNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ErParserProvider
					.getParser(
							ErElementTypes.Key_3004,
							getParserElement(),
							ErVisualIDRegistry
									.getType(er.diagram.edit.parts.KeyNameEditPart.VISUAL_ID));
		}
		return parser;
	}
