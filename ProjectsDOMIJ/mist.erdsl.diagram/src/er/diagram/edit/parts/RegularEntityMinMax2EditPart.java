 ...
 * @generated
 */
public class RegularEntityMinMax2EditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(
				ErVisualIDRegistry
						.getType(er.diagram.edit.parts.RegularEntityMinMax2EditPart.VISUAL_ID),
				new Point(0, 0));
	}
	 ...
	 * @generated
	 */
	public RegularEntityMinMax2EditPart(View view) {
		super(view);
	}
	...
	protected IFigure createFigurePrim() {
		return new RegularEntityLabelFigure();
	}

	/**
	 * @generated
	 */
	public class RegularEntityLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public RegularEntityLabelFigure() {
			this.setText("RegularEntity");
		}
