 ...
 * @generated
 */
public class IdentificationDependencyNameEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public IdentificationDependencyNameEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = ErParserProvider
					.getParser(
							...
							getParserElement(),
							ErVisualIDRegistry
									.getType(er.diagram.edit.parts.IdentificationDependencyNameEditPart.VISUAL_ID));
		}
		return parser;
	}
