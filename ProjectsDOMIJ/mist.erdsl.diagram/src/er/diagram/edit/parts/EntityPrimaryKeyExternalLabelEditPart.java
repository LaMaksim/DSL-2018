 ...
 * @generated
 */
public class EntityPrimaryKeyExternalLabelEditPart extends LabelEditPart
	...
	static {
		registerSnapBackPosition(
				ErVisualIDRegistry
						.getType(er.diagram.edit.parts.EntityPrimaryKeyExternalLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public EntityPrimaryKeyExternalLabelEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ErParserProvider.getParser(
					ErElementTypes.EntityPrimaryKey_4001, getParserElement(),
	...
	protected IFigure createFigurePrim() {
		return new EntityPrimaryKeyExternalLabelFigure();
	}

	/**
	 * @generated
	 */
	public class EntityPrimaryKeyExternalLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public EntityPrimaryKeyExternalLabelFigure() {
