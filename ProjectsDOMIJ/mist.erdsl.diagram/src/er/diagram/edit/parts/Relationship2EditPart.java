...
import er.diagram.edit.policies.Relationship2CanonicalEditPolicy;
import er.diagram.edit.policies.Relationship2ItemSemanticEditPolicy;
...
public class Relationship2EditPart extends AbstractBorderedShapeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof RegularEntityEditPart) {
			BorderItemLocator locator = new BorderItemLocator(getMainFigure(),
					PositionConstants.NORTH);
			getBorderedFigure().getBorderItemContainer().add(
					((RegularEntityEditPart) childEditPart).getFigure(),
					locator);
			return true;
		}
		return false;
