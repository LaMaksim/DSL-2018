...
import er.diagram.edit.policies.ErTextSelectionEditPolicy;
 ...
 * @generated
 */
public class IdentificationDependencyWeakEntityExternalLabelEditPart extends
	...
	static {
		registerSnapBackPosition(
				ErVisualIDRegistry
						.getType(er.diagram.edit.parts.IdentificationDependencyWeakEntityExternalLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public IdentificationDependencyWeakEntityExternalLabelEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ErParserProvider.getParser(
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					ErEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
	...
	protected IFigure createFigurePrim() {
		return new IdentificationDependencyWeakEntityExternalLabelFigure();
	}

	/**
	 * @generated
	 */
	public class IdentificationDependencyWeakEntityExternalLabelFigure extends
			WrappingLabel {

		/**
		 * @generated
		 */
		public IdentificationDependencyWeakEntityExternalLabelFigure() {
			this.setText("weakEntity");
		}
