...
import er.diagram.edit.policies.EntityCanonicalEditPolicy;
import er.diagram.edit.policies.EntityItemSemanticEditPolicy;
...
public class EntityEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof EntityEntityKeySetCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getEntityKeySetCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((EntityEntityKeySetCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof EntityEntityKeySetCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getEntityKeySetCompartmentFigure();
			pane.remove(((EntityEntityKeySetCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof EntityEntityKeySetCompartmentEditPart) {
			return getPrimaryShape().getEntityKeySetCompartmentFigure();
		}
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == ErElementTypes.Key_3004) {
				return getChildBySemanticHint(ErVisualIDRegistry
	 ...
	 * @generated
	 */
	public class EntityFigure extends ScalablePolygonShape {
		 ...
		 * @generated
		 */
		private RectangleFigure fEntityKeySetCompartmentFigure;
		...
		private void createContents() {
			...
			fFigureEntityLabelFigure.setMaximumSize(new Dimension(getMapMode()
					.DPtoLP(10000), getMapMode().DPtoLP(50)));

			this.add(fFigureEntityLabelFigure);

			fEntityKeySetCompartmentFigure = new RectangleFigure();

			fEntityKeySetCompartmentFigure.setOutline(false);

			this.add(fEntityKeySetCompartmentFigure);
		 ...
		 * @generated
		 */
		public RectangleFigure getEntityKeySetCompartmentFigure() {
			return fEntityKeySetCompartmentFigure;
		}
