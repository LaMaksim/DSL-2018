 ...
 * @generated
 */
public class ISANameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ISANameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ErParserProvider
					.getParser(
							ErElementTypes.ISA_2006,
							getParserElement(),
							ErVisualIDRegistry
									.getType(er.diagram.edit.parts.ISANameEditPart.VISUAL_ID));
		}
		return parser;
	}
