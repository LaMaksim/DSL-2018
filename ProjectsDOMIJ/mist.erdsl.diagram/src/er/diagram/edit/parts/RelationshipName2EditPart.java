 ...
 * @generated
 */
public class RelationshipName2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ErParserProvider
					.getParser(
							ErElementTypes.Relationship_3011,
							getParserElement(),
							ErVisualIDRegistry
									.getType(er.diagram.edit.parts.RelationshipName2EditPart.VISUAL_ID));
		}
		return parser;
	}
