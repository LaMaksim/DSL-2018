 ...
 * @generated
 */
public class CategorisationNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public CategorisationNameEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = ErParserProvider
					.getParser(
							...
							getParserElement(),
							ErVisualIDRegistry
									.getType(er.diagram.edit.parts.CategorisationNameEditPart.VISUAL_ID));
		}
		return parser;
	}
