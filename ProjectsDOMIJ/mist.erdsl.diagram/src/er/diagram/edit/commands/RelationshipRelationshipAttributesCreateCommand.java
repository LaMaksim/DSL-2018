 ...
 * @generated
 */
public class RelationshipRelationshipAttributesCreateCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public RelationshipRelationshipAttributesCreateCommand(
	...
	public boolean canExecute() {
		...
		return ErBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateRelationshipRelationshipAttributes_4013(getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getRelationshipAttributes().add(getTarget());
		}
