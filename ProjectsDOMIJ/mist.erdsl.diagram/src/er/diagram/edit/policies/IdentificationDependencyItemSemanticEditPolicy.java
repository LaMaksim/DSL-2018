...
import er.diagram.edit.commands.RegularEntity3CreateCommand;
 ...
 * @generated
 */
public class IdentificationDependencyItemSemanticEditPolicy extends
		ErBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public IdentificationDependencyItemSemanticEditPolicy() {
		super(ErElementTypes.IdentificationDependency_2008);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (ErElementTypes.RegularEntity_3010 == req.getElementType()) {
			return getGEFWrapper(new RegularEntity3CreateCommand(req));
		}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (ErVisualIDRegistry.getVisualID(outgoingLink) == IdentificationDependencyWeakEntityEditPart.VISUAL_ID) {
