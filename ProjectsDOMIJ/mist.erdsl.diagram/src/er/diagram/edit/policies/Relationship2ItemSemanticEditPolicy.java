...
import er.diagram.edit.commands.RegularEntityCreateCommand;
...
public class Relationship2ItemSemanticEditPolicy extends
	...
	public Relationship2ItemSemanticEditPolicy() {
		super(ErElementTypes.Relationship_3011);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (ErElementTypes.RegularEntity_3005 == req.getElementType()) {
			return getGEFWrapper(new RegularEntityCreateCommand(req));
		}
