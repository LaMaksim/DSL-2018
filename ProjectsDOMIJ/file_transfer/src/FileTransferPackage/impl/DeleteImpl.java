 ...
 * <ul>
 *   <li>{@link FileTransferPackage.impl.DeleteImpl#getSource <em>Source</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DeleteImpl extends MinimalEObjectImpl.Container implements Delete {
	...
	protected EClass eStaticClass() {
		return FileTransferPackagePackage.Literals.DELETE;
	}
		...
		if (source != null && source.eIsProxy()) {
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FileTransferPackagePackage.DELETE__SOURCE, oldSource, source));
			}
		}
		return source;
	}
	...
	public void setSource(Selection newSource) {
		...
		source = newSource;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FileTransferPackagePackage.DELETE__SOURCE, oldSource, source));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FileTransferPackagePackage.DELETE__SOURCE:
