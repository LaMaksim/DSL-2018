		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getModelAccess().getExecutionsAssignment_3_2(), "rule__Model__ExecutionsAssignment_3_2");
					put(grammarAccess.getModelAccess().getExecutionsAssignment_3_3_1(), "rule__Model__ExecutionsAssignment_3_3_1");
