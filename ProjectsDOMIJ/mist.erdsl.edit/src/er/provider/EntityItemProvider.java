...
/**
 * This is the item provider adapter for a {@link er.Entity} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
  ...
  extends ModellingConceptItemProvider
{
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ErPackage.Literals.ENTITY__PRIMARY_KEY,
				 true,
				 false,
				 true,
				 null,
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
  {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ErPackage.Literals.ENTITY__ENTITY_ATTRIBUTES);
			childrenFeatures.add(ErPackage.Literals.ENTITY__KEY_SET);
		}
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
  {
		...
		newChildDescriptors.add
			(createChildParameter
				(ErPackage.Literals.ENTITY__ENTITY_ATTRIBUTES,
				 ErFactory.eINSTANCE.createAttribute()));

		newChildDescriptors.add
			(createChildParameter
				(ErPackage.Literals.ENTITY__KEY_SET,
				 ErFactory.eINSTANCE.createKey()));
	}
