...
/**
 * This is the item provider adapter for a {@link FileTransferPackage.FilterContainer} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FilterContainerItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FilterContainer_compositionType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FilterContainer_compositionType_feature", "_UI_FilterContainer_type"),
				 FileTransferPackagePackage.Literals.FILTER_CONTAINER__COMPOSITION_TYPE,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FileTransferPackagePackage.Literals.FILTER_CONTAINER__SEGMENTS);
		}
	...
	public String getText(Object object) {
		CompositionType labelValue = ((FilterContainer)object).getCompositionType();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_FilterContainer_type") :
