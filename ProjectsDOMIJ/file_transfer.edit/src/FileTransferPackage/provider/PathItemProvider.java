...
/**
 * This is the item provider adapter for a {@link FileTransferPackage.Path} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PathItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Path_absolute_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Path_absolute_feature", "_UI_Path_type"),
				 FileTransferPackagePackage.Literals.PATH__ABSOLUTE,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FileTransferPackagePackage.Literals.PATH__STEPS);
		}
	...
	public String getText(Object object) {
		...
		return getString("_UI_Path_type") + " " + path.isAbsolute();
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(FileTransferPackagePackage.Literals.PATH__STEPS,
				 FileTransferPackageFactory.eINSTANCE.createConcreteStep()));

		newChildDescriptors.add
			(createChildParameter
				(FileTransferPackagePackage.Literals.PATH__STEPS,
				 FileTransferPackageFactory.eINSTANCE.createVariableStep()));

		newChildDescriptors.add
			(createChildParameter
				(FileTransferPackagePackage.Literals.PATH__STEPS,
				 FileTransferPackageFactory.eINSTANCE.createParametrizedStep()));
	}
