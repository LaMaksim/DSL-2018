...
/**
 * This is the item provider adapter for a {@link FileTransferPackage.ConcreteStep} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConcreteStepItemProvider
	 ...
	 * @generated
	 */
	public ConcreteStepItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ConcreteStep_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ConcreteStep_value_feature", "_UI_ConcreteStep_type"),
				 FileTransferPackagePackage.Literals.CONCRETE_STEP__VALUE,
				 true,
				 false,
				 false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ConcreteStep"));
	}
	...
	public String getText(Object object) {
		String label = ((ConcreteStep)object).getValue();
		return label == null || label.length() == 0 ?
			getString("_UI_ConcreteStep_type") :
			getString("_UI_ConcreteStep_type") + " " + label;
	}
