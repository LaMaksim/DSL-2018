...
public class OnTagsItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addQuantificatorPropertyDescriptor(object);
		}
	...
	/**
	 * This adds a property descriptor for the Quantificator feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addQuantificatorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_OnTags_quantificator_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_OnTags_quantificator_feature", "_UI_OnTags_type"),
				 FileTransferPackagePackage.Literals.ON_TAGS__QUANTIFICATOR,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		...
		return getString("_UI_OnTags_type") + " " + onTags.isInverse();
	}
