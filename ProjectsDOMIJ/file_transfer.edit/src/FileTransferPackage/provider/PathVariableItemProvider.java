...
/**
 * This is the item provider adapter for a {@link FileTransferPackage.PathVariable} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PathVariableItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PathVariable_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PathVariable_name_feature", "_UI_PathVariable_type"),
				 FileTransferPackagePackage.Literals.PATH_VARIABLE__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FileTransferPackagePackage.Literals.PATH_VARIABLE__VALUE);
		}
	...
	public String getText(Object object) {
		String label = ((PathVariable)object).getName();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(FileTransferPackagePackage.Literals.PATH_VARIABLE__VALUE,
