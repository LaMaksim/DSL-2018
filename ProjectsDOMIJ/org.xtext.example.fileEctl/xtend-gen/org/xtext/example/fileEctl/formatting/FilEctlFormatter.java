 ...
 * generated by Xtext
 */
package org.xtext.example.fileEctl.formatting;
...
public class FilEctlFormatter extends AbstractDeclarativeFormatter {
  @Inject
  @Extension
  private FilEctlGrammarAccess _filEctlGrammarAccess;
  
  protected void configureFormatting(final FormattingConfig c) {
    List<Pair<Keyword,Keyword>> _findKeywordPairs = this._filEctlGrammarAccess.findKeywordPairs("{", "}");
    ...
    List<Keyword> _findKeywords = this._filEctlGrammarAccess.findKeywords(",");
    ...
    TerminalRule _sL_COMMENTRule = this._filEctlGrammarAccess.getSL_COMMENTRule();
    _setLinewrap.before(_sL_COMMENTRule);
    FormattingConfig.LinewrapLocator _setLinewrap_1 = c.setLinewrap(0, 1, 2);
    TerminalRule _mL_COMMENTRule = this._filEctlGrammarAccess.getML_COMMENTRule();
    _setLinewrap_1.before(_mL_COMMENTRule);
    FormattingConfig.LinewrapLocator _setLinewrap_2 = c.setLinewrap(0, 1, 1);
    TerminalRule _mL_COMMENTRule_1 = this._filEctlGrammarAccess.getML_COMMENTRule();
